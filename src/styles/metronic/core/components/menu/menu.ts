import {createPopper, Instance as PopperInstance, Placement, VirtualElement} from '@popperjs/core';
import KTDom from '../../helpers/dom';
import KTUtils from '../../helpers/utils';
import KTData from '../../helpers/data';
import KTEventHandler from '../../helpers/event-handler';
import KTComponent from '../component';
import {KTMenuConfigInterface, KTMenuInterface, KTMenuItemToggleType, KTMenuItemTriggerType} from './types';
...
export class KTMenu extends KTComponent implements KTMenuInterface {
    ...
    protected _isItemSubShown(itemElement: HTMLElement): boolean {
        ...
        if (subElement !== null) {
            if (this._getItemToggleMode(itemElement) === 'dropdown') {
                if (subElement) {
                    if (subElement.classList.contains('show') && subElement.hasAttribute('data-popper-placement')) {
                        return true;
                    }
                } else {
                    console.error('subElement is undefined');
                    return false;
                }
            } else {
