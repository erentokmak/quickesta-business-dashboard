...
import {KTTooltipConfigInterface, KTTooltipInterface, KTTooltipTriggerType} from './types';
import {createPopper, Instance, Placement, PositioningStrategy} from '@popperjs/core';
