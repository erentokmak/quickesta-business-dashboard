...
export default {
  ...
  plugins: [
    require('./src/styles/metronic/core/plugins/plugin'),
    require('./src/styles/metronic/core/plugins/components/theme'),
    require('./src/styles/metronic/core/plugins/components/breakpoints'),
    require('./src/styles/metronic/core/plugins/components/typography'),
    require('./src/styles/metronic/core/plugins/components/menu'),
    require('./src/styles/metronic/core/plugins/components/dropdown'),
    require('./src/styles/metronic/core/plugins/components/accordion'),
    require('./src/styles/metronic/core/plugins/components/input'),
    require('./src/styles/metronic/core/plugins/components/input-group'),
    require('./src/styles/metronic/core/plugins/components/select'),
    require('./src/styles/metronic/core/plugins/components/textarea'),
    require('./src/styles/metronic/core/plugins/components/file-input'),
    require('./src/styles/metronic/core/plugins/components/switch'),
    require('./src/styles/metronic/core/plugins/components/checkbox'),
    require('./src/styles/metronic/core/plugins/components/radio'),
    require('./src/styles/metronic/core/plugins/components/range'),
    require('./src/styles/metronic/core/plugins/components/container'),
    require('./src/styles/metronic/core/plugins/components/image-input'),
    require('./src/styles/metronic/core/plugins/components/modal'),
    require('./src/styles/metronic/core/plugins/components/drawer'),
    require('./src/styles/metronic/core/plugins/components/tooltip'),
    require('./src/styles/metronic/core/plugins/components/popover'),
    require('./src/styles/metronic/core/plugins/components/btn'),
    require('./src/styles/metronic/core/plugins/components/btn-group'),
    require('./src/styles/metronic/core/plugins/components/tabs'),
    require('./src/styles/metronic/core/plugins/components/pagination'),
    require('./src/styles/metronic/core/plugins/components/card'),
    require('./src/styles/metronic/core/plugins/components/table'),
    require('./src/styles/metronic/core/plugins/components/badge'),
    require('./src/styles/metronic/core/plugins/components/rating'),
    require('./src/styles/metronic/core/plugins/components/scrollable'),
    require('./src/styles/metronic/core/plugins/components/progress'),
    require('./src/styles/metronic/core/plugins/components/apexcharts'),
    require('./src/styles/metronic/core/plugins/components/leaflet'),
  ],
}
